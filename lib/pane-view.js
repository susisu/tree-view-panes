...
export default class PaneView {
  constructor(parent, pane, name, index, state) {
    ...
    this._onDragOver = event => {
      ...
      this._headerElement.classList.add('drag-over');
    };
    ...
    this._headerElement.addEventListener('dragenter', this._onDragEnter);
    this._onDragLeave = event => {
      event.stopPropagation();
      event.preventDefault();
      this._headerElement.classList.remove('drag-over');
    };
    this._headerElement.addEventListener('dragleave', this._onDragLeave);
    this._onDrop = event => {
      event.stopPropagation();
      event.preventDefault();
      this._headerElement.classList.remove('drag-over');
      ...
      if (fromPaneView === this) {
        this.pane.moveItem(itemView.item, 0);
  ...
  destroy() {
    ...
    this._headerElement.removeEventListener('dragenter', this._onDragEnter);
    this._headerElement.removeEventListener('dragleave', this._onDragLeave);
