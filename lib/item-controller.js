...
export default class ItemController {
  constructor(parent, item, index) {
    ...
    this.showPending = atom.config.get('working-files.showPendingItems');
    this.showStatus  = atom.config.get('working-files.showGitStatus');
    ...
    this.configSub.add(atom.config.observe(
      'working-files.showPendingItems',
      showPendingItems => {
    ...
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:close-item',
      () => { this.parent.closeItem(this.item); }
    ));
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:close-other-items',
    ...
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:split-up-and-move',
      () => {
    ...
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:split-down-and-move',
      () => {
    ...
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:split-left-and-move',
      () => {
    ...
    this.commandsSub.add(atom.commands.add(
      this.view.element,
      'working-files:split-right-and-move',
      () => {
    ...
    this.onDragStart = event => {
      ...
      this.parent.activateItem(this.item);
      // set data
      event.dataTransfer.setData('working-files-event', 'true');
